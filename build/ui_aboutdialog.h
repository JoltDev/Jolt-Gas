...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About JoltGas", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>JoltGas</b> version", 0));
...
"Copyright \302\251 2017-2018 The JoltGas developers", 0));
