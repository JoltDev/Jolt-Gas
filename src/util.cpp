...
int nAnonymizeJoltGasAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\JoltGas
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\JoltGas
    // Mac: ~/Library/Application Support/JoltGas
    // Unix: ~/.joltgas
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "JoltGas";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "joltgas.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "joltgasd.pid"));
